        ...
        <div className='custom-bg px-5'>
            ...
            <div className='flex lg:px-[30rem] w-full '>
                ...
                <div className='lg:w-full text-center justify-center h-full pt-[10rem] px-4 '>
                    <h2 className='lg:text-7xl text-3xl font-semibold leading-tight'>Electoral committee of <br /> Namibia(ECN)</h2>
                    <p className='py-5 px-4'>Vote securely on the blockchain and protect your vote</p>
                    
                    <button onClick = {connectWallet} class="btn btn-active lg:w-1/2 w-3/4 text-white lg:text-lg btn-primary bg-gradient-to-r
